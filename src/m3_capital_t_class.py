    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        # ---------------------------------------------------------------------
        uppercorner_h = rg.Point((intersection_center.x + (width/2)), (intersection_center.y + (letter_thickness/2)))
        lowercorner_h = rg.Point((intersection_center.x - (width/2)), (intersection_center.y - (letter_thickness/2)))
        self.h_rect = rg.Rectangle(uppercorner_h, lowercorner_h)
        uppercorner_v = rg.Point((intersection_center.x + (letter_thickness / 2)),(intersection_center.y + (height - letter_thickness / 2)))
        lowercorner_v = rg.Point((intersection_center.x - (letter_thickness / 2)),(intersection_center.y - (letter_thickness / 2)))
        self.v_rect = rg.Rectangle(uppercorner_v, lowercorner_v)
    ...
    def clone(self):
        ...
        letter_thickness = self.v_rect.get_width()
